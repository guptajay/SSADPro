...
class DatabaseService {
  ...
  final CollectionReference studentUserCollection = Firestore.instance
  ...
  Future updateStudentUserData(String name, String group, String email,
      String progress, List<int> points, List<String> dates, int total_attempts,
  ...
  Future updateUserAssignment(String name, String topic, String status,
      String fileName) async {
    return await Firestore.instance.runTransaction((transaction) async {
      await transaction.set(Firestore.instance.collection(USER_COLLECTION)
          .document(this.email)
